...
export default function ETFExplorer() {
  ...
  useEffect(() => {
    ...
    },
    {
      ...
      pe: null,
      pb: null,
      top_holdings: ["Physical Gold"],
      aum: 2800,
      inception: "2014-03-20",
      tradable: true
    },
    {
      id: 4,
    ...
    },
    {
      ...
      aum: 1800,
      inception: "2019-01-10",
      tradable: true
    },
    {
      id: 6,
      name: "Edelweiss ETF - Nifty IT",
      symbol: "ITEIT",
      category: "Sector",
      underlying: "NIFTY IT",
      nav: 234.56,
    ...
    {
      id: 7,
      name: "Aditya Birla SL ETF Nifty PSU Bank",
      symbol: "ABSLPSUBNKBEES",
      category: "Sector",
      ...
      pe: 8.9,
      pb: 0.8,
      top_holdings: ["SBIN", "PNB", "BOB", "CANBK", "UCOBANK"],
      aum: 800,
      inception: "2017-04-28",
      tradable: true
    }
  ]
