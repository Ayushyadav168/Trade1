...
import { TrendingUp, TrendingDown, Clock, ExternalLink, Filter, Search, Calendar, Sparkles } from 'lucide-react'
...
export default function NewsWidget() {
  ...
  const generateMarketInsights = async () => {
    ...
    try {
      const insights = await geminiService.getMarketInsights(filteredNews)
      setAiInsights(insights)
      setShowAiInsights(true)
    } catch (error) {
      setAiInsights('Unable to generate market insights at the moment.')
      setShowAiInsights(true)
    } finally {
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-3 py-1 rounded-lg text-sm font-medium hover:from-purple-700 hover:to-blue-700 transition-all flex items-center space-x-1"
          >
            {loadingInsights ? (
        ...
        <div className="mb-6 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg p-4 border border-purple-200">
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-medium text-purple-900">AI Market Insights</span>
            </div>
            <button
